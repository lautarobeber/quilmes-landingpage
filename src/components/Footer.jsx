      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
       ...
       {/*  <img 
        ...
        <div className="flex gap-6 mb-8">
          <a href="https://www.facebook.com/quilmescerveza" target="_blank" rel="noopener noreferrer" className="hover:text-[#0085CC] transition-colors">
            <i className="ri-facebook-fill text-3xl"></i>
          </a>
          <a href="https://www.instagram.com/cervezaquilmes/?hl=en" target="_blank" rel="noopener noreferrer" className="hover:text-[#0085CC] transition-colors">
            <i className="ri-instagram-fill text-3xl"></i>
          </a>
          <a href="https://x.com/Quilmes_Cerveza" target="_blank" rel="noopener noreferrer" className="hover:text-[#0085CC] transition-colors">
            <i className="ri-twitter-fill text-3xl"></i>
          </a>
          <a href="https://www.youtube.com/@quilmescerveza" target="_blank" rel="noopener noreferrer" className="hover:text-[#0085CC] transition-colors">
            <i className="ri-youtube-fill text-3xl"></i>
          </a>
          <a href="https://www.tiktok.com/@quilmes_cerveza" target="_blank" rel="noopener noreferrer" className="hover:text-[#0085CC] transition-colors">
